        ...
        .then(data => {
            ...
            function createFiltersForIndex(idx) {
                ...
                selectedFiltr.items.forEach(one => {
                    ...
                    filterInput.addEventListener('change', filterPhonesByBrands)
                });
            ...
            function filterPhonesByBrands() {
                ...
                const checkedBrands = Array.from(document.querySelectorAll('.check-span .check-in:checked'))
                    .map(input => input.value.toLowerCase())

                console.log('checkedbrands', checkedBrands)

                const phoneFilter = data.Phones.filter(phone => {
                ...
                console.log("existPage", existPage)
            ...
            console.log('the writes:', allLiWrites)

            allLiWrites.forEach((li, idx) => {

                console.log('li:', li, 'idx', idx)
