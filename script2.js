document.addEventListener('DOMContentLoaded',()=>{
 ...
 // ==================== main body =============================
    ...
    const theSearchInput = document.querySelector('.search-brand')
    
    theSearchInput.addEventListener('input',()=>{
        const filtering = theSearchInput.value.toLowerCase()
        const leftDatas = document.querySelectorAll('.phone-sec')

        leftDatas.forEach(h1 =>{
            const h1Tag = h1.querySelector('.data-left h1').textContent.toLowerCase()

            if(h1Tag.includes(filtering)){
